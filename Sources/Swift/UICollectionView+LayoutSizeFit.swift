...
public extension LayoutSizeFitWrapper where Base: UICollectionView {
    ...
    var fittingSizeCacheBuilder: JSLayoutSizeFitCacheBuilder {
        return self.base.js_fittingSizeCacheBuilder
    }
    
    func setFittingSizeCacheBuilder(_ builder: JSLayoutSizeFitCacheBuilder?) {
        self.base.js_fittingSizeCacheBuilder = builder
    }
